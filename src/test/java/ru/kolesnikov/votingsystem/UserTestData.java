...
public class UserTestData {
    ...
    public static final User USER_C = new User(USER_C_ID, "user_C", Role.USER);
    public static final User USER_D = new User(USER_D_ID, "user_D", Role.USER);
    public static final User USER_E = new User(USER_E_ID, "user_E", Role.USER);
    public static final User USER_F = new User(USER_F_ID, "user_F", Role.USER);
    public static final User USER_G = new User(USER_G_ID, "user_G", Role.USER);
